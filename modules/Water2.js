...
import { Refractor } from '../modules/Refractor.js';
...
class Water extends Mesh {
	...
	constructor(geometry, options = {}) {
		...
		const normalMap0 = options.normalMap0 || textureLoader.load('../src/assets/Water1.jpg');
		const normalMap1 = options.normalMap1 || textureLoader.load('../src/assets/Water2.jpg');
